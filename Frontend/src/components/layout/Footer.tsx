...
import { Zap, Mail, Phone, MapPin, Linkedin, Instagram, Facebook, Twitter, ChevronRight, Send } from "lucide-react"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mb-6">
                Empowering brands and engineering futures through innovative digital solutions. We help businesses grow
                with cutting-edge technology and design-driven experiences.
              </p>
