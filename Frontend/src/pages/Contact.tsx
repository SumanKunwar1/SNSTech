      ...
      <section className="relative py-24 md:py-32 overflow-hidden bg-gradient-to-br from-teal-50 to-white dark:from-gray-800 dark:to-gray-900">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Let's{" "}
              <span className="bg-gradient-to-r from-teal-600 to-blue-600 bg-clip-text text-transparent">Connect</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Ready to transform your business? We'd love to hear about your project and explore how we can help you
              achieve your goals.
            </motion.p>
          </div>
        </div>
              ...
              >
                <Card className="h-full border border-gray-200 dark:border-gray-800 shadow-md hover:shadow-lg transition-all duration-300 bg-white dark:bg-gray-900 rounded-xl overflow-hidden flex flex-col justify-between">
                  <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-xl text-gray-800 dark:text-gray-100">{info.title}</h3>
                      {info.copyable ? (
                        <CopyToClipboard text={info.content}>
                          <p className="text-teal-600 dark:text-teal-400 font-medium text-lg">{info.content}</p>
                        </CopyToClipboard>
                      ) : info.link ? (
                        <a
                          href={info.link}
            ...
            >
              <Card className="flex-1 border border-gray-200 dark:border-gray-800 shadow-xl bg-white dark:bg-gray-900 rounded-xl">
                <CardContent className="p-8">
                  <div className="mb-8">
                    <h3 className="text-3xl font-bold mb-2 text-gray-800 dark:text-gray-100">Send us a Message</h3>
              ...
              <Card className="flex-1 border border-gray-200 dark:border-gray-800 shadow-xl bg-white dark:bg-gray-900 rounded-xl overflow-hidden">
                <CardContent className="p-0 h-full flex flex-col">
                  <div className="p-8 pb-0">
                    <h3 className="text-3xl font-bold mb-2 text-gray-800 dark:text-gray-100">Our Location</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-teal-100 mb-8">
              Schedule a free 30-minute consultation to discuss your project in detail and discover how we can bring
              your vision to life.
            </p>
            <a
